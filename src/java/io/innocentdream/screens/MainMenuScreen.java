...
public class MainMenuScreen extends Screen {
    ...
    public MainMenuScreen(Identifier source) {
        ...
        this.playBtn = new Button(-150, 60, 5.0F, new Text("Play")).addOnClickListener(button -> {
            //TODO play screen
        });
        this.quitBtn = new Button(-150, -40, 5.0F, new Text("Quit")).addOnClickListener(button -> {
